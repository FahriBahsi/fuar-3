...
export const metadata: Metadata = {
  title: 'Blog Places - Direo',
  description: 'Read our latest blog posts about places and destinations',
};

export default async function BlogPlacesPage() {
                  ...
                  <div className="widget-default">
                    ...
                    <div className="widget-content">
                      <div className="category-widget">
                        <ul>
                          <li className="arrow-list4"><a href="">Places</a></li>
                          <li className="arrow-list4"><a href="">Destinations</a></li>
                          <li className="arrow-list4"><a href="">Travel</a></li>
                          <li className="arrow-list4"><a href="">Tourism</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
