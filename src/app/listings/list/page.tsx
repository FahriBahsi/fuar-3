...
export const metadata: Metadata = {
  title: 'All Listings - List View',
  description: 'Browse all available listings in list view',
};
...
export default async function ListingsListPage({ searchParams }: PageProps) {
              ...
              <div className="atbd_generic_header">
                ...
                <div className="atbd_listing_action_btn btn-toolbar align-items-center" role="toolbar">
                  ...
                  <div className="view-mode">
                    <Link href="/listings" className="action-btn">
                      <span className="la la-th-large"></span>
                    </Link>
                    <Link href="/listings/list" className="action-btn active">
                ...
                <div className="col-lg-8 order-lg-1 order-0">
                  {listingsData.listings.length > 0 ? (
                    ...
                    <div className="no-results text-center py-5">
                      ...
                      <Link href="/listings/list" className="btn btn-primary mt-3">
                        Clear Filters
                      </Link>
                    </div>
                  )}
